...
Thank you for registering for ICBB 2016. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@bbseries.org. You can find the copyright form here: www.bbseries.org/papers. Please note that failing to do so may result in an unsuccessful process of your registration.

You can find your registration details below. If there are any errors in the information you have provided, please write an email to us at registration@bbseries.org mentioning the correct information. Please note that you SHOULD NOT refill the form.
...
$your_subject = "Your Registration Details for ICBB'16";

$your_headers = "From: ICBB'16 <" . $my_email . ">";
...
<title>ICBB'16 - Registration Form Filled!</title>
...
<div id="content">
  ...
  <header>
	...
	<div class="cbp-af-inner">
        ...
        <div class="bg">
          <h1>2<sup>nd</sup> International Conference on<br>Bioengineering and Biotechnology (ICBB'16)</h1>
 ...
 <div class="unit unit-s-3-4 unit-m-3-4 unit-l-3-4">
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      <h2 class="title">1</h2>
      <p class="bold">ICBB 2016:</p>
      <p class="body">ICBB 2016 will  be held in Ottawa, Canada on August 19 - 20, 2016.</p>
    </div>          
    <div>
      <h2 class="title">2</h2>
  ...
  <div class="unit-spacer content">
    ...
    <p class="body">If you do not receive an email, <strong>please check your SPAM folder</strong>.</p>
 	...
 	<p class="body">If you have requested any official invitation letters, please allow up to 5 business days to receive your documents.</p> 
  	...
  	<p class="body">If there are any problems in the information you have filled out, please write an email to us at <a href="mailto:registration@bbseries.org" class="body-link">registration@bbseries.org</a> mentioning the mistakes made. Please note that you SHOULD NOT refill the form.</p>

	<p class="body">We are looking forward to seeing you at ICBB'16!</p>
  </div>
</div>
...
<footer id="contact">
	...
	<div class="unit-spacer">
		...
		+1-613-695-3040<br>
		<a href="mailto:info@bbseries.org">info@bbseries.org</a></p>
		</div>
	</div>

	<div class="unit unit-s-1 unit-m-2-3 unit-l-2-3 contact">
	<div class="unit-spacer">
	<p class="body">For questions or comments regarding ICBB'16, please fill out the form below:</p>
