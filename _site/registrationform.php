...
Thank you for registering for ICBB 2017. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your camera ready version and a signed copyright form via email to info@bbseries.org. You can find the copyright form here: www.2017.bbseries.org/papers. Please note that failing to do so may result in an unsuccessful process of your registration.
...
$your_subject = "Your Registration Details for ICBB'17";

$your_headers = "From: ICBB'17 <" . $my_email . ">";
...
<title>ICBB'17 - Registration Form Filled!</title>
...
<p class="body" style="text-align:center!important; color: #FFF!important;">ICBB'17 is part of the <b>3<sup>rd</sup> World Congress on New Technologies (NewTech'17)</b>.<br>For more information about the congress, please visit the website here: <a href="http://2017.newtechcongress.com/" class="body-link">www.2017.newtechcongress.com</a>.</p>
  ...
  <div class="unit unit-s-1 unit-m-1-3-1 unit-l-1-3-1">
    ...
    <div>
      ...
      <p class="body">ICBB 2017 will  be held in Rome, Italy on June 7 - 8, 2017.</p>
    </div>       
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">We are looking forward to seeing you at ICBB'17!</p>
  </div>
</div>
