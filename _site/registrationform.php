...
Thank you for registering for ICBB 2019. If you have requested any official letters, please allow up to 5 business days to receive your documents.

If you are an author, please make sure to send us your final version (.doc or .docx format) and a signed copyright form via email to info@bbseries.org. You can find the copyright form here: https://bbseries.org/papers. Please note that failing to do so may result in an unsuccessful process of your registration.
...
We are pleased to announce that the ICBB 2019 be held at the Hotel Real Palácio. Additionally, we have collaborated with the hotel to offer our attendees a reduced 
rate on their accommodations! This discounted rate is only valid until May 12, 2019. Please view the booking form here: https://bbseries.org/RealPalacioLisbonBookingForm.pdf
...
$your_subject = "Your Registration Details for ICBB'19";

$your_headers = "From: ICBB'19 <" . $my_email . ">";
...
<title>ICBB'19 - Registration Form Filled!</title>
...
<div class="unit unit-s-1 unit-m-1-4-1 unit-l-1-4-1">
  ...
  <p class="body">We are looking forward to seeing you at ICBB'19!</p>
  </div>
</div>
